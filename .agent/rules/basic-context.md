...
O usuário programa no Windows, com o VS Code (Antigravity) e terminal Powershell. Ele versiona seus projetos no github. Ele usa uma VPS para publicar seus sistemas na internet. Então, os projetos precisam ser pensados para rodar localmente em um ambiente de desenvolvimento, mas estarem aptos a serem enviados para a VPS para publicação no ambiente de produção. Assuma que o usuário já possui instalado o VS Code, o Python, GitHub e Docker no seu ambiente de desenvolvimento.
...
labels:
      ...
      - "traefik.http.services.portainer.loadbalancer.server.port=xxx"

      # Define o roteador HTTPS

      - "traefik.http.routers.portainer.rule=Host(`xxx.ovictorfarias.com.br`)"
